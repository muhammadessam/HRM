...
$users = \App\User::all();
 ?>
    ...
    <div class="panel panel-default">
      <h3 class="page-title hos-site">
        <center>
        تحضير مكـــــان عمل الموظـــف
      </center>
      </h3>
                        ...
                        <div class="panel panel-default">
                            <div class="panel-body">
                              <div class="col-md-12">
                                <div class="form-group">
                                  ...
                                  اختر الموظف:
                                    ...
                                    <select class="form-control staff_select" id="staff">
                              ...
                              <div class=" col-md-12"><br><br</div>
                                ...
                                <div class="col-md-3">
                                  ...
                                  <div class="form-group">
                                    ...
                                    <label for="exampleInputEmail1">
                                      ...
                                      <button  class="btn hos-info" id="br_maps" style="border: 1px solid #b4b7b98f;">
                                ...
                                <hr style="border: 2px solid #b4b7b98f;border-radius:10px;width:100%;">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/eskanaho/public_html/resources/views/admin/users/maps.blade.php ENDPATH**/ ?>