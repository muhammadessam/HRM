...
<?php $__env->startSection('content'); ?>
    ...
    <h3 class="page-title"><?php echo app('translator')->getFromJson('quickadmin.pointings.title'); ?></h3>
                ...
                <?php if(count($pointings) > 0): ?>
                    <?php $__currentLoopData = $pointings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pointing): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr data-entry-id="<?php echo e($pointing->id); ?>" data-color="<?php echo e($pointing->color); ?>">
                            ...
                            <td>
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('pointing_edit')): ?>
                                    <a href="<?php echo e(route('admin.pointings.edit',[$pointing->id])); ?>" class="btn btn-xs btn-info"><?php echo app('translator')->getFromJson('quickadmin.qa_edit'); ?></a>
                                <?php endif; ?>
                            </td>
                        </tr>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\ensraf\resources\views/admin/pointings/index.blade.php ENDPATH**/ ?>