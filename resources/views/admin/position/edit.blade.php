...
@section('content')
  <form  action="{{url('admin/position/'.$position->id.'/update')}}" method="post">
    @csrf
    <div class="panel panel-default">
        <div class="panel-heading">
            تعديل الموقع: <strong>{{$position->title}}</strong>
        </div>
        ...
        <div class="panel-body">
            <div class="row">
                <div class="col-xs-12 form-group">
                    ...
                    {!! Form::text('title', $position->title, ['class' => 'form-control', 'placeholder' => '', 'required' => '']) !!}
            ...
            <div class="row">
                <div class="col-xs-4 form-group">
                    ...
                    {!! Form::text('lat', $position->lat, ['class' => 'form-control', 'placeholder' => '', 'required' => ''  , 'id' => 'lat']) !!}
                    <p class="help-block"></p>
                    @if($errors->has('name'))
                        <p class="help-block">
                            {{ $errors->first('name') }}
                ...
                <div class="col-xs-4 form-group">
                    ...
                    {!! Form::text('lng', $position->lng, ['class' => 'form-control', 'placeholder' => '', 'required' => '' , 'id' => 'lng']) !!}
                    <p class="help-block"></p>
                    @if($errors->has('name'))
                        <p class="help-block">
                            {{ $errors->first('name') }}
