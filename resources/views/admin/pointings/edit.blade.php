...
@section('content')
    ...
    {!! Form::model($pointing, ['method' => 'PUT', 'route' => ['admin.pointings.update', $pointing->id]]) !!}
    {!! Form::hidden('user_id', $pointing->user->id) !!}
    
    @component('components.user', ['user' => $pointing->user])
    @endcomponent

    <p><span>اليوم :</span>{{ $pointing->day }}</p>
        ...
        <div class="panel-body">
            <div class="row">
                <div class="col-xs-12 form-group">
                    ...
                    {!! Form::select('period', $periods, old('period') ?: ($period ? $period->id : ''), ['class' => 'form-control', 'required' => '']) !!}
